 ...
 *
 */
public class CentralizedSequentialLinda extends AbstractCentralizedLinda {
	 ...
	 * 
	 */
	public CentralizedSequentialLinda() {
		super();
	 ...
	 * 
	 */
	public CentralizedSequentialLinda(String name) throws IOException {
		super();
